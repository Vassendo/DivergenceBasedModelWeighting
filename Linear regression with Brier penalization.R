#This is the code used to conduct one of the simulations in Section E of the appendix: 
...
run <- foreach(trials = 1:n_trials) %dorng% {
  ...
  for(number in 1:13){
    ...
    model_weights2 <- divergence_weights2(pointwise = pointwise, prior = prior)
